...
describe('Bloco #Filter', () => {
   ...
   it('filter([1,2,2,1,5,5,8,3], (item, index, array) => array) should return [1,2,5,8,3]', () => {
      const before = filter([1,2,2,1,5,5,8,3], (item, index, array) => index === array.indexOf(item))
